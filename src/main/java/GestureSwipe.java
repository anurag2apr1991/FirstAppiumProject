...
//        t.press(PointOption.point(477,1891)).waitAction(WaitOptions.waitOptions(Duration.ofMillis(20)))
//                .moveTo(PointOption.point(494,386)).release().perform();
        //endpoint and startpoint based on
//        for (int i = 0; i < 3; i++) {
//            TouchAction t = new TouchAction(driver);
//            t.press(PointOption.point(startX, startY)).waitAction(WaitOptions.waitOptions(Duration.ofMillis(20)))
